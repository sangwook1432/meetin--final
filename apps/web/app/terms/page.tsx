        ...
        <section className="space-y-8 text-sm leading-relaxed text-gray-700">
          ...
          <div>
            ...
            <ul className="space-y-2 list-none">
              ...
              <li>④ &quot;지갑&quot;이란 서비스 내 충전 및 매칭권 구매에 사용되는 가상 잔액을 말합니다.</li>
              <li>⑤ &quot;애프터 신청&quot;이란 미팅 종료 후 상대방에게 연락처와 메시지를 전달하는 기능을 말합니다.</li>
              <li>⑥ &quot;오프라인 미팅&quot;이란 서비스를 통해 매칭된 이용자들이 실제로 만나는 행위를 말하며, 이는 이용자들의 자발적 의사에 의해 이루어집니다.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 list-none">
              ...
              <li>② 운영자는 재학 인증(재학증명서 또는 학생증)을 요구할 수 있으며, 인증이 완료되지 않은 경우 일부 기능을 제한할 수 있습니다.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 list-none">
              ...
              <li>③ 친구 기능은 상호 요청 및 수락을 통해 이용 가능하며, 언제든지 친구 관계를 종료할 수 있습니다.</li>
              <li>④ 애프터 신청 기능을 이용하면 신청인의 휴대폰 번호가 수신인에게 공개됩니다. 이용자는 이 점을 인지하고 자발적으로 신청하여야 합니다.</li>
            </ul>
          </div>
            ...
            <div className="space-y-5">
                ...
                <ul className="space-y-1.5 list-none">
                  ...
                  <li>② 본 규정에서 사용하는 용어의 정의는 다음과 같습니다.
                    <ul className="mt-1.5 ml-4 space-y-1 list-none">
                      ...
                      <li>- <strong>&quot;무상 재화&quot;</strong>라 함은 회사가 이벤트, 프로모션, 신규 가입 보상(웰컴 보너스), 관리자 지급 등을 통해 회원에게 무료로 지급한 매칭권을 의미합니다.</li>
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1.5 list-none">
                  ...
                  <li>② 서비스 제공기간: 결제 완료 즉시 지갑 잔액에 충전되며, 매칭권은 구매 즉시 지급됩니다.</li>
              ...
              <div>
                ...
                <ul className="space-y-1.5 list-none">
                  ...
                  <li>② 일반 환불 시, 회사는 결제 대행 수수료, 송금 비용 및 시스템 운영비 등을 보전하기 위하여 <strong>환불 대상 금액의 10% (최소 공제 수수료 1,000원)</strong>를 환불 수수료로 공제한 후, 원결제 수단(카드 등)으로 환불합니다.</li>
              ...
              <div>
                ...
                <ul className="space-y-1.5 list-none">
                  ...
                  <li>② 회사가 회원에게 무상으로 지급한 &quot;무상 재화(웰컴 보너스, 관리자 지급 등)&quot;는 어떠한 경우에도 현금으로 환불되거나 교환되지 않습니다.</li>
                  <li>③ 회원이 본 서비스의 이용약관을 위반하여 계정 이용 정지, 강제 탈퇴 등의 제재 조치를 받은 경우, 해당 회원이 보유한 지갑 잔액 및 매칭권은 제재 즉시 소멸하며 환불 대상에서 제외됩니다.</li>
                  <li>④ 미팅 확정 후 회원의 귀책사유(노쇼, 일방적 취소 등)로 인하여 매칭권이 차감된 경우, 해당 매칭권은 복구 및 환불되지 않습니다.</li>
                </ul>
              </div>
          ...
          <div>
            ...
            <ul className="space-y-1 list-none">
              ...
              <li>⑧ 애프터 신청 기능을 통해 취득한 상대방 연락처를 스팸, 성희롱, 불법 영업 등 부적절한 목적으로 사용하는 행위</li>
              <li>⑨ 허위 신고, 악의적 신고 등 신고 기능을 남용하는 행위</li>
            </ul>
            <p className="mt-2">위 행위 적발 시 운영자는 사전 통보 없이 경고 누적 또는 계정 정지·영구 탈퇴 처리할 수 있습니다.</p>
          </div>

          <div>
            <h2 className="mb-3 text-base font-bold text-gray-900">제9조 (이용자 제재)</h2>
            <ul className="space-y-2 list-none">
              <li>① 서비스 내 신고 기능을 통해 접수된 신고는 운영자가 검토하여 처리합니다.</li>
              <li>② 신고가 확정되면 피신고 이용자에게 경고가 누적되며, 누적 횟수에 따라 다음과 같이 제재됩니다.
                <ul className="mt-1 ml-4 space-y-1 list-disc text-gray-600">
                  <li>1회: 경고 알림</li>
                  <li>2회: 일정 기간 서비스 이용 정지</li>
                  <li>3회: 계정 영구 정지</li>
                </ul>
              </li>
              <li>③ 운영자는 사안의 중대성에 따라 경고 절차 없이 즉시 영구 정지 조치를 취할 수 있습니다.</li>
            </ul>
          </div>

          <div>
            <h2 className="mb-3 text-base font-bold text-gray-900">제10조 (회원 탈퇴)</h2>
            <ul className="space-y-2 list-none">
          ...
          <div>
            <h2 className="mb-3 text-base font-bold text-gray-900">제11조 (면책 조항)</h2>
            <ul className="space-y-2 list-none">
              <li>① 운영자는 천재지변, 전쟁, 기간통신사업자의 서비스 중단 등 불가항력으로 인한 서비스 장애에 대해 책임을 지지 않습니다.</li>
              <li>② <strong>MEETIN.은 이용자 간의 만남을 주선하는 플랫폼으로서, 오프라인 미팅 및 그 이후에 발생하는 모든 사고·분쟁·손해(신체적 피해, 성범죄, 폭행, 사기, 재산 피해 등을 포함하나 이에 한정되지 않음)에 대해 일체의 법적 책임을 지지 않습니다.</strong> 이용자는 오프라인 만남이 전적으로 본인의 자유의사에 의한 것임을 인지하고 이에 동의합니다.</li>
              <li>③ 운영자는 이용자 간 채팅 또는 애프터 신청을 통해 교환된 연락처 정보의 남용으로 인한 피해에 대해 직접적인 책임을 지지 않습니다. 다만, 신고 접수 시 적극적으로 조치합니다.</li>
              <li>④ 운영자는 이용자가 타인의 허위 정보(학교, 신분 등)로 인해 입은 피해에 대해 직접적인 책임을 지지 않습니다. 재학 인증은 대학교 재학 여부를 확인하는 절차이나, 이용자의 모든 정보의 진실성을 보증하지는 않습니다.</li>
              <li>⑤ 운영자는 이용자가 서비스를 통해 기대하는 결과를 보장하지 않습니다.</li>
            </ul>
          </div>

          <div>
            <h2 className="mb-3 text-base font-bold text-gray-900">제12조 (분쟁 해결)</h2>
            <ul className="space-y-2 list-none">
